      ...
      <div className="max-w-4xl mx-auto text-center pt-8">
        ...
        <footer className="mt-24 text-sm text-gray-400 max-w-2xl mx-auto">
          <p className="leading-relaxed">
            Your privacy matters. We <span className="font-semibold text-gray-300">never</span> store your personal data. This matching process is completely anonymous and secure.
          </p>
        </footer>
      </div>
    </div>
